...
func TestQueryBuilder(t *testing.T) {
	...
	query, err := builder.
		...
		Build()
	expected := `{"fields":["fieldOne","fieldTwo","fieldThree","fieldFour","fieldFive"],"limit":10,"selector":{"$or":[{"id":5},{"ids":10},{"$and":[{"a":1},{"b":2},{"$or":[{"x":0},{"x":100}]}]}],"categories":["a","b"],"docType":"items","id":[1,2,3],"name":"peckstadt","singleID":1,"testFieldForCondition":{"$neq":1}},"skip":20,"sort":[{"docType":"desc"},{"createdAt":"desc"}],"use_index":"_design/idDoc"}`
